...
export const fetchBlogs = async ({ queryKey }) => {
  ...
  const res = await fetch(
    `${process.env.NEXT_PUBLIC_API_BASE}/blogs/allBlogs?page=${page}&limit=6`,
    {
      method: "GET",
      headers: {
...
export const fetchLatestBlogs = async () => {
  const res = await fetch(
    `${process.env.NEXT_PUBLIC_API_BASE}/blogs/latestBlogs`,
    {
      method: "GET",
      headers: {
        "Content-Type": "application/json",
...
export const fetchBlogsFrontend = async ({ queryKey }) => {
  ...
  const res = await fetch(
    `${process.env.NEXT_PUBLIC_API_BASE}/blogs/allBlogs?page=${page}&limit=8`,
    {
      method: "GET",
      headers: {
        "Content-Type": "application/json",
