    ...
    <dialog ref={ref} id="clientModal" className="modal">
      <div className="modal-box">
        <form className="fieldset" onSubmit={handleSubmit(handleClient)}>
          ...
          <input type="text" className="input w-full" placeholder="Write Client's Name" {...register("clientName", { required: isEditing ? false : "Client Name is required", minLength: { value: 3, message: "Client Name must be at least 3 characters long" } })} />
          ...
          <div className="modal-action">
            ...
            <button type="submit" className={`btn btn-primary ${loading ? "" : "btn-nexoro-primary"}`} disabled={loading ? true : false}>
