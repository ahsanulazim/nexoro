      ...
      <div className="card-body">
        <div className="flex items-center justify-between gap-5">
          <div className="flex items-center gap-2">
            {client.logo ? (
              ...
              <div className="shrink-0 bg-base-200 rounded-box size-12 p-3 flex items-center justify-center">
                <FaUsers />
              </div>
            )}
            <div>
              <h2 className="card-title line-clamp-2">{client.name}</h2>
              <p>{client.role}</p>
            </div>
          </div>
        ...
        <div className="grid grid-cols-2 gap-5">
          ...
          <div>
            ...
            <p className="line-clamp-2 opacity-50">
