...
const AddBlog = () => {
    ...
    return (
        <>
            ...
            <form className="grid grid-cols-4 gap-5 items-start" onSubmit={handleSubmit(onSubmit)}>
                <div className="fieldset col-span-3 bg-base-200 border-base-300 rounded-box border p-5">
                    ...
                    <button className="btn btn-success mt-4" type="submit">Post Blog</button>
                </div>
                <div className="flex flex-col gap-5">
                    ...
                    <div className="fieldset bg-base-200 border-base-300 rounded-box border p-5">
                        ...
                        <div className="flex gap-3 items-center"><input type="radio" value="visible" id="visible" className="radio radio-xs radio-success" {...register("visibility", { required: "Visibility is required" })} /><label htmlFor="visible">Visible</label></div>
                        <div className="flex gap-3 items-center"><input type="radio" value="hidden" id="hidden" className="radio radio-xs radio-success" {...register("visibility", { required: "Visibility is required" })} /><label htmlFor="hidden">Hidden</label></div>
