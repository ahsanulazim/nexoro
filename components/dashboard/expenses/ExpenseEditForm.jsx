...
import { getExpense, updateExpense } from "@/api/fetchExpense";
import { toast } from "react-toastify";
import { useEffect } from "react";

const ExpenseEditForm = ({ ref, id }) => {
  //get expense data
  ...
  const onSubmit = async (data) => {
    saveExpenseMutation.mutate({ id, data });
  };
      ...
      <div className="modal-box">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="fieldset">
          ...
          <div className="modal-action">
            ...
            <button
              type="submit"
              className={`btn ${saveExpenseMutation.isPending ? "" : "btn-nexoro-primary"}`}
