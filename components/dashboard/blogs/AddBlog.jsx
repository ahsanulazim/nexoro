    ...
    <>
      ...
      >
        <div className="fieldset lg:col-span-3 bg-base-200 border-base-300 rounded-box border p-5 max-lg:order-2">
          ...
          />
          {errors.blogTitle && (
            <p className="text-red-600">{errors.blogTitle.message}</p>
          )}
          ...
          {errors.blogDescription && (
            <p className="text-red-600">{errors.blogDescription.message}</p>
          )}
        ...
        <div className="flex flex-col gap-5 max-lg:order-1 sticky top-20">
          ...
          <div className="fieldset bg-base-200 border-base-300 rounded-box border p-5">
            ...
            >
              <LuCirclePlus className="size-4" /> Add New Category
            </button>
            {errors.category && (
          ...
          <div className="fieldset bg-base-200 border-base-300 rounded-box border p-5">
            <label className="label">
              Upload Blog Thumbnail <span className="text-red-600">*</span>
            </label>
            <input
              type="file"
