...
import TeamCardSkeleton from "../dashboard/skeleton/TeamCardSkeleton";
    ...
    <section ref={teamRef} className="relative" id="team">
      ...
      <div className="max-w-[1426px] px-5 py-10 lg:py-20 mx-auto z-10">
        ...
        <motion.div
          ...
          className="grid grid-cols-1 xs:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-5 lg:gap-10"
        >
          {isLoading
